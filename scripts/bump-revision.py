...
for name in ['rpd-backlight-m10','rpd-autorotate','rpd-settings-backend','labwc','gtk-layer-shell','rpd-login','rpd-session','rpd-desktop-lite','rpd-desktop-m10','rpd-desktop-browser']:
