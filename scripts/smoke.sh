...
cp /tmp/rpd-headless.log /tmp/rpd-headless.png /tmp/rpd-keyboard.png /tmp/rpd-classic-menu.png /tmp/rpd-control-center.png /tmp/rpd-control-center.log out/
